...
app.post('/sign-in', (req, res) => { login.handleSignIn(req, res, db, bcrypt) })
...
app.post('/is-favorited', middleware.checkToken, (req, res) => { favorites.checkIfFavorited(req, res, db)})
...
app.post('/deck-entries-id', middleware.checkToken, (req, res) => { learn.getDeckEntries(req, res, db)})
